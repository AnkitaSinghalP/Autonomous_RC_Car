...
/**
 * Created by shilpa on 16-Dec-16.
 */
public class ThreadConnectBTdevice extends Thread {
    ...
    Activity activity;
    Context context;
    ThreadConnectBTdevice(BluetoothSocket socket, Activity activity, Context context){
    ...
    boolean getBluetoothConnection(){
        ...
        ThreadConnectBTdevice.mmOutputStream = tmpOut;
        ThreadConnectBTdevice.mmInputStream = tmpIn;
